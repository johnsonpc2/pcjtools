...
#'
#' @param path a filepath string naming a directory with files to read. All
#' files of the type named in extension will be read into a single data.table
#' object
